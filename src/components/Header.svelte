<div class="flex flex-row justify-evenly bg-blue-500 p-5">
    ...
    <span class="flex flex-row min-h-full px-5 gap-x-3">
        ...
        <a class="fa-solid fa-heart text-3xl cursor-select" href=" https://www.youtube.com/watch?v=phiq7Pp5mpU&list=LL&index=1" target="_blank" aria-label=k></a>
        <i class="fa-solid fa-gear text-3xl"></i>
        <i class="fa-solid fa-moon text-3xl"></i>
    </span>     
    <div class="ml-auto min-h-full flex items-center">
        <h1 >About me</h1>
    </div>
</div>  